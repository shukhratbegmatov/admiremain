        ...
        <div class="row">
          ...
          <div class="col-12 create_pro">
            ...
            <div class="input_group" v-if="user.data">
              ...
              >
                <option
                  v-for="(item, index) in user.data.productTypes"
                  :key="index"
                  :value="item.id"
                  :selected="index == 0"
                >
          ...
          <div class="col-12">
            ...
            <div class="row form_radio" v-if="user.data">
              <div
                class="col-6"
                v-for="items in user.data.paymentTypes"
                :key="items"
              >
                <b-form-radio
                  v-model="selected"
              ...
              <div class="f_times">
                <div class="date_f">
                  ...
                  >
                    <g opacity="0.9">
                      <path
                        d="M10.0003 16.6667C13.222 16.6667 15.8337 14.055 15.8337 10.8333C15.8337 7.61167 13.222 5 10.0003 5C6.77866 5 4.16699 7.61167 4.16699 10.8333C4.16699 14.055 6.77866 16.6667 10.0003 16.6667Z"
                        stroke="#191923"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      ...
                      />
                      <path
                        d="M5.83366 3.33334L3.54199 5.00001"
                        stroke="#191923"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M14.167 3.33334L16.4587 5.00001"
                        stroke="#191923"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
...
export default {
  ...
  mounted() {
    ...
    if (this.$store.state.auth.user) {
      ...
      this.selecteds.value =
        this.$store.state.auth.user.data.productTypes[0].value;
  ...
  methods: {
    ...
    submit() {
      ...
      console.log(
        this.times,
        this.date.toDateString() + " " + this.hour + this.minute
      );
    },
  },
  computed: {
